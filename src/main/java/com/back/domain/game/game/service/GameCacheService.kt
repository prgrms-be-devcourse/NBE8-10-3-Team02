...
class GameCacheService(
    ...
    fun putGameDetail(igdbId: Long, response: GameDetailResponse) {
    ...
    fun putVideo(igdbId: Long, response: GameVideoResponse) {
    ...
    fun putSimilarIds(igdbId: Long, ids: List<Long>) {
    ...
    fun putSimilarList(igdbId: Long, list: List<SimilarGameResponse>) {
    ...
    fun putIgdbPopularGames(key: String, list: List<PopularGameCardDto>) {
